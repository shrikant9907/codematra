...
<div class="common-section-ui pb_60">
      <div class="container">
        ...
        <div class="row">
          <?php
          if ($handle = opendir(ABSPATH.'/tuts-images/doyouknow')) {
              ...
              if ($file != "." && $file != "..") {
                ...
                <div class="col-12 col-md-6">
                  <div class="card cui3 r_0 doyouknow mb_20">
                    ...
                    <div class="card-body p-2 text-center d-flex justify-content-center align-items-center">
                      <div class="sharecard">
                        <p class="mb-0">Share on social media...</p>
                        <ul class="socialicons siconsb mx-auto"> 
                          ...
                          <li class="whatsapp"><a href="https://api.whatsapp.com/send?text=<?php the_permalink(); ?>" title="Whats App" target="_blank"><i class="fab fa-whatsapp"></i></a></li>
