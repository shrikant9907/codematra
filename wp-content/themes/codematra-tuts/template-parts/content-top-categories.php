    ...
    <div class="ourtutorials row no-gutters">
      ...
      if ($fcats): 
        foreach($fcats as $fcat) {
          ...
          ?>  
          <div class="col-12">
            <div  data-aos="fade-up" class="card cui1 r_0 noshadow relative mbi_0">
              ...
              <div class="pb_10 pt_5 px_15 relative d-flex align-items-center">
                ...
                <div class="">
                  <h3 class="card-title font_normal mbi_5"><a  class="text-dark f16 lh16 font_normal" href="<?php echo site_url($fcat['link']); ?>"><?php echo $fcat['name']; ?></a></h3>
