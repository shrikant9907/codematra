<!-- 
Bootstrap 5 - Pricing Card Component | https://codematra.com/
-->
<div class="card shadow py-3 mx-auto mt-3 text-center mb-5" style="max-width: 300px;">
  <div class="card-body">
  <h5 class="card-title text-muted text-uppercase mb-3">Free</h5>
  <div class="mb-3 fs-1 d-flex justify-content-center align-items-center">
    <sup class="text-muted fs-6 me-1">$</sup>
    <span class="font-weight-bold">0</span>
    <sub class="text-muted fs-6 ms-1">/mo</sub>
  </div>
  ...
  <div class=""><a href="#" class="btn btn-primary btn-lg fs-6 rounded-pill px-4">Choose Plan</a></div>
  </div>
</div>